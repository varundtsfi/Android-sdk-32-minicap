...
public:
  ...
  // virtual android::PhysicalDisplayId getDisplayId() {    
  //    return mDisplayId;
  //  }
...
private:
  //android::PhysicalDisplayId mDisplayId;
  uint32_t mRealWidth;
  ...
  createVirtualDisplay() {
    ...
    t.setDisplaySurface(mVirtualDisplay, mBufferProducer);
     MCINFO("2");
    t.setDisplayProjection(mVirtualDisplay, android::ui::ROTATION_0, layerStackRect, visibleRect);
     MCINFO("3");
...
int
minicap_try_get_display_info(Minicap::DisplayInfo* info) {
  android::status_t err;
